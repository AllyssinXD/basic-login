    ...
    return (
        <Container style={{width: "450px"}} className="d-flex flex-column justify-content-center align-items-center min-vh-100">
            ...
            <Form className="w-100 border p-5 rounded bg-white">
                <Row><h1 className="mb-5">Registre-se</h1></Row>  
                        <Row className="mb-3"><FormGroup>
                        <FormLabel>Nome de Usuário</FormLabel>
                        <FormControl type="text" placeholder="Exemplo123" value={username} onChange={(e)=>{setUsername(e.target.value)}}></FormControl>
                        </FormGroup></Row>
                        ...
                        <Row>
                            <Col className="w-50 d-flex align-items-center">
                                <Button onClick={handleSubmit} className="w-100">Registrar</Button>
                            </Col>
